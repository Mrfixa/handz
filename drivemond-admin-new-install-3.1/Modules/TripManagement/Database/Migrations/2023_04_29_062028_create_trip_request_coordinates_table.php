...
class CreateTripRequestCoordinatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('trip_request_coordinates', function (Blueprint $table) {
            ...
            $table->string('int_coordinate_1')->nullable();
            $table->boolean('is_reached_1')->default(false);
            $table->string('int_coordinate_2')->nullable();
            ...
            $table->string('drop_coordinates')->nullable();
            $table->string('driver_accept_coordinates')->nullable();
            $table->string('customer_request_coordinates')->nullable();
            $table->timestamps();
        });
    }
