...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        $this->setEnvironmentValue('PUSHER_APP_ID', 'vito');
        $this->setEnvironmentValue('PUSHER_APP_KEY', 'vito');
        $this->setEnvironmentValue('PUSHER_APP_SECRET', 'vito');
        ...
        $this->setEnvironmentValue('REVERB_APP_ID', 'vito');
        $this->setEnvironmentValue('REVERB_APP_KEY', 'vito');
        $this->setEnvironmentValue('REVERB_APP_SECRET', 'vito');
